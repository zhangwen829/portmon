      ...
      <Table>
        <TableHead>
          <TableRow className={classes.headBackground}>
            ...
            <TableCell className={classes.headText} numeric>
              Position
            </TableCell>
            <TableCell className={classes.headText} numeric>
              Last Price
              ...
              return (
                ...
                >
                  <TableCell className={classes.cellText}>
                    {sessionSecurity.ticker}
                  </TableCell>
                  <TableCell className={classes.cellText} numeric>
                    {sessionSecurity.position}
                  </TableCell>
                  <TableCell
                    className={
                      sessionSecurity.upward === undefined
                        ? classes.cellText
                        : sessionSecurity.upward
                          ? classes.cellLastPriceUp
                          : classes.cellLastPriceDown
                    }
                    numeric
                  >
                    {sessionSecurity.lastPrice}{" "}
                    {sessionSecurity.upward === undefined ? (
                      <ArrowForward />
                    ) : sessionSecurity.upward ? (
                      <ArrowUpward />
